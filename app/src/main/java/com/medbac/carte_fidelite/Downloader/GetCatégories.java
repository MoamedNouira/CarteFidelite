...
/**
 * Created by Mohamed Nouira on 04/04/2015.
 */
public class GetCatégories {
    ...
    public GetCatégories(String url, String id_categories, Context context){
        this.context = context;
        this.url = url+"?id_categories="+id_categories;
